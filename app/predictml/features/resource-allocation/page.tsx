          ...
          <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Optimize your workforce and resource management with AI-powered predictive analytics
              </p>
            </motion.div>
            ...
            >
              {[
                { number: "40%", label: "Resource Optimization" },
                { number: "25%", label: "Cost Reduction" },
                { number: "85%", label: "Staff Satisfaction" }
              ].map((stat, index) => (
                <motion.div
                  key={index}
            ...
            {[
              {
                ...
                description: "AI-powered scheduling that adapts to your team's availability and workload",
                icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"
              },
              {
                title: "Workload Analysis",
                description: "Real-time insights into team capacity and resource utilization",
                icon: "M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"
              },
              {
                title: "Predictive Planning",
                description: "Forecast resource needs based on historical data and trends",
              ...
              <div className="w-full md:w-1/2">
                ...
                >
                  ...
                  <p className="text-gray-400 mb-8">
                    Watch how our smart resource allocation system helps businesses optimize their operations and reduce costs while improving employee satisfaction.
                  </p>
                  <button className="px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-500 transition-colors">
                    Watch Demo
                  </button>
                </motion.div>
              </div>
              <div className="w-full md:w-1/2">
                <div className="aspect-video rounded-xl overflow-hidden bg-black/50 border border-purple-500/20">
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 mb-8">
              Join companies that have achieved up to 40% improvement in resource utilization.
            </p>
            <Link 
              href="/contact" 
